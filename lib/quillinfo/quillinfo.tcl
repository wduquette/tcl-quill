...
namespace eval ::quillinfo {
    variable meta
    array set meta {gui-quill 0 apptypes-quill {linux osx windows} url http://my.home.page description {Quill Project Build System for Tcl/Tk} provides quill homepage http://github.com/wduquette/tcl-quill requires {Tcl snit textutil::expander} version-textutil::expander 1.3.1 version-snit 2.3 local-Tcl 0 apps quill local-textutil::expander 0 local-snit 0 version 0.2.0a1 version-Tcl 8.6 project tcl-quill}
