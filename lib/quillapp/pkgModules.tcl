...
package provide quillapp 0.2.2a0
# -quill-provide-end
...
source [file join $::quillapp::library tool_env.tcl         ]
source [file join $::quillapp::library tool_help.tcl        ]
source [file join $::quillapp::library tool_info.tcl        ]
source [file join $::quillapp::library tool_install.tcl     ]
source [file join $::quillapp::library tool_new.tcl         ]
source [file join $::quillapp::library tool_replace.tcl     ]
source [file join $::quillapp::library tool_run.tcl         ]
source [file join $::quillapp::library tool_shell.tcl       ]
source [file join $::quillapp::library tool_teapot.tcl      ]
