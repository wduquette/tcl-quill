...
set ::quillapp::help(deps) {
	...
	"quill deps update" attempts to install all missing dependencies.
	Optionally, one or more package names can be specified explicitly.

	"quill deps refresh" attempts to remove and re-install all 
	dependencies.  Optionally, one or more package names can be
